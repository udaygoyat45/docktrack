...
let project_data : FeatureTree.m =
  { title = "auto documentation title"; url = None; descr = None }
...
let new_feature_to_ct name parent_name metadata (code_tree : CodeTree.ct) =
  let feature_tree' =
    FeatureTree.add_feature name parent_name metadata code_tree.feature_tree
  in
  { code_tree with feature_tree = feature_tree' }

let child1 : FeatureTree.m =
  { title = "feature tree title"; url = None; descr = None }

and child2 : FeatureTree.m =
  { title = "feature update title"; url = None; descr = None }

and child3 : FeatureTree.m =
  { title = "pretty print title"; url = None; descr = None }

and child4 : FeatureTree.m =
  { title = "ds utils title"; url = None; descr = None }
